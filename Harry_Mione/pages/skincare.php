...
<div id="mySidenav" class="sidenav">
	<a href="skincare.php" style="color: #f1f1f1;">SKIN CARE</a>
...
<div class="col-lg-12 coverImgContainer">
	<img class="coverImg" src="cover/skincare.jpg">
</div>	

<?php $query = "SELECT productID, productName, productBrand, price FROM Products WHERE category = 'Skincare'"; ?>						
<?php
