...
<div id="mySidenav" class="sidenav">
	<a href="skincare.php">SKIN CARE</a>
   	<a href="makeup.php" style="color: #f1f1f1;">MAKEUP</a>
...
<div class="col-lg-12 coverImgContainer">
	<img class="coverImg" src="cover/makeup.jpg">
</div>	

<?php $query = "SELECT productID, productName, productBrand, price FROM Products WHERE category = 'Makeup'"; ?>						
<?php
