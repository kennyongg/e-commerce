...
<div id="mySidenav" class="sidenav">
	...
	<a href="body.php" style="color: #f1f1f1;">BODY</a>
	<br><br>
        <?php 
...
<div class="col-lg-12 coverImgContainer">
	<img class="coverImg" src="cover/body.jpg">
</div>	

<?php $query = "SELECT productID, productName, productBrand, price FROM Products WHERE category = 'Body'"; ?>						
<?php 
